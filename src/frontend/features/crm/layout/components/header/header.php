<?php
namespace frontend\features\crm\layout\components\header;

use frontend\core\base\Component;
use ports\AssetManagerPort;
use frontend\features\crm\layout\components\user_card\UserCard;
...
class Header extends Component {
    public function render($props = []): string {
        ...
        $assetManager->load("/frontend/features/crm/layout/components/header/header.css");
